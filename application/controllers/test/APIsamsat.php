...
class ApiSamsat extends CI_Controller {
	...
	public function APIlogin(){
		header('Content-Type: application/json');
				...
				// $url = 'http://localhost:8080/public_apps/api/samsat/login';
				$url = 'https://project.opus-id.com/siondel/api/samsat/login';
